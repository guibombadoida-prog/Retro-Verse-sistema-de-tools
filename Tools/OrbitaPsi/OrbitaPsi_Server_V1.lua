--[[
	OrbitaPsi_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: OrbitaPsi → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "OrbitaPsi",
	TOOLTIP         = "OrbitaPsi - descrição breve da ferramenta",

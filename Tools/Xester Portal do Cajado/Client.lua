-- Client.lua
-- Script com RunContext = Client — Xester Portal do Cajado  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterPortal_R"
local ACAO_T = "Xester_XesterPortal_T"
local ACAO_Y = "Xester_XesterPortal_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Saida")
	...
	ContextActionService:SetTitle(ACAO_T, "Atravessar")
	...
	ContextActionService:SetTitle(ACAO_Y, "Fechar")

-- JupiterRaioJoviano_Server_V1.lua
-- Script de servidor — Jupiter Raio Joviano  (conjunto JUPITER)
--
...
--   T    Tormenta   (Extra 2)
--
--   Handle: lanca preta com ponta em neon azul
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "JupiterRaio", Poses,

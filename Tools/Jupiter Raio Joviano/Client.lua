-- Client.lua
-- Script com RunContext = Client — Jupiter Raio Joviano  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterRaio_R"
local ACAO_T = "Jupiter_JupiterRaio_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Cadeia")
	...
	ContextActionService:SetTitle(ACAO_T, "Tormenta")

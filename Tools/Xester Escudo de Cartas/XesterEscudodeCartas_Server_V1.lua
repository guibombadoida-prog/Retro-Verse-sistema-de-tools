...
-- Script de servidor — Xester Escudo de Cartas  (Xester Forma 1)
--
...
--
--   M1   escudo orbital   (a mecânica da origem, preservada)
--   R    Rebater   (Extra 1)
--   T    Estilhacar   (Extra 2)
--   Y    Baralho Blindado   (Extra 3)
--
-- DE ONDE VEM O MATERIAL
--
--   Forma 1 — SOBE · REBATE · ESTILHACA · SOPRO
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterEscudo", Poses,

-- Client.lua
-- Script com RunContext = Client — Xester Escudo de Cartas  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterEscudo_R"
local ACAO_T = "Xester_XesterEscudo_T"
local ACAO_Y = "Xester_XesterEscudo_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Rebater")
	...
	ContextActionService:SetTitle(ACAO_T, "Estilhacar")
	...
	ContextActionService:SetTitle(ACAO_Y, "Baralho Blindado")

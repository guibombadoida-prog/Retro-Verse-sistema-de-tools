-- Client.lua
-- Script com RunContext = Client — Xester Esfera do Fim  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterEsfera_R"
local ACAO_T = "Xester_XesterEsfera_T"
local ACAO_Y = "Xester_XesterEsfera_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Orbita")
	...
	ContextActionService:SetTitle(ACAO_T, "Compressao")
	...
	ContextActionService:SetTitle(ACAO_Y, "O Fim")

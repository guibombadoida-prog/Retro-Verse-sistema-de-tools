-- Poses.lua
-- ModuleScript "Poses" — Parada do Tempo  (conjunto NOOB)
--
...
--
--   PARAR        conjuração       1.20s · 5 passo(s), 2 segurado(s)
--   RELOGIO      golpe pesado     1.30s · 5 passo(s), 2 segurado(s)
--
...
P.PARA_MAO = {
	RightArm = CFrame.new(1.52, 0.4, -1.2) * CFrame.Angles(math.rad(92), math.rad(-4), math.rad(-4)),
	LeftArm = CFrame.new(-1.42, 0.1, -0.34) * CFrame.Angles(math.rad(32), math.rad(10), math.rad(14)),
...
P.SEQUENCIAS = {
	...
	PARAR = {
		{ pose = "ABRE_PALMA", time = 0.22, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "ABRE_PALMA", time = 0.28, style = "Sine", dir = "InOut", tremor = 0.03, freq = 21 },
		{ pose = "PARA_MAO", time = 0.12, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "PARA_MAO", time = 0.26, style = "Sine", dir = "InOut" },
		{ pose = "IDLE", time = 0.32, style = "Quad", dir = "Out" },
	},

	-- golpe pesado · 1.30s · 5 passo(s), 2 segurado(s)
	RELOGIO = {
		{ pose = "PUXA_PEITO", time = 0.24, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "PUXA_PEITO", time = 0.44, style = "Sine", dir = "InOut", tremor = 0.04, freq = 26 },
		{ pose = "ABRE_PALMA", time = 0.13, style = "Quint", dir = "Out", marca = "GOLPE" },

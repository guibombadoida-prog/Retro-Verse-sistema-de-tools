-- Poses.lua
-- ModuleScript "Poses" — Lancador de Objetos  (conjunto GRAVIDADE)
--
...
P.SEQUENCIAS = {
	...
	ARREMESSO = {
		{ pose = "PUXA", time = 0.2, style = "Back", dir = "In", marca = "AGARRA" },
		{ pose = "PUXA", time = 0.28, style = "Sine", dir = "InOut" },
		{ pose = "ABRE_MAO", time = 0.1, style = "Quint", dir = "Out", marca = "SOLTA" },
		{ pose = "ABRE_MAO", time = 0.12, style = "Sine", dir = "InOut" },
		{ pose = "IDLE", time = 0.2, style = "Quad", dir = "Out" },
	},

	-- conjuração pesada · 1.20s · 5 passo(s), 2 segurado(s)
	RAJADA = {
		{ pose = "PUXA", time = 0.24, style = "Back", dir = "In", marca = "REUNE" },
		{ pose = "PUXA", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.035, freq = 22, marca = "SEGURA" },

-- Client.lua
-- Script com RunContext = Client — Lancador de Objetos  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravLancador_R"
local ACAO_T = "Gravidade_GravLancador_T"
local ACAO_Y = "Gravidade_GravLancador_Y"
local ALCANCE_MIRA = 140
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Rajada")
	...
	ContextActionService:SetTitle(ACAO_T, "Prender")
	...
	ContextActionService:SetTitle(ACAO_Y, "Despejo")

--[[
	MaoTelecinetica_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: MaoTelecinetica → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "MaoTelecinetica",
	TOOLTIP         = "MaoTelecinetica - descrição breve da ferramenta",

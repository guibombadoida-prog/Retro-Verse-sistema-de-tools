-- Client.lua
-- Script com RunContext = Client — Paradoxo  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoParadoxo_R"
local ACAO_T = "Tempo_TempoParadoxo_T"
local ALCANCE_MIRA = 45
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Duplo")
	...
	ContextActionService:SetTitle(ACAO_T, "Colapso de Linha")

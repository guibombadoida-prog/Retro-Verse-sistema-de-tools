-- Client.lua
-- Script com RunContext = Client — Asas Telecineticas  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravAsas_R"
local ACAO_T = "Gravidade_GravAsas_T"
local ACAO_Y = "Gravidade_GravAsas_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Mergulho")
	...
	ContextActionService:SetTitle(ACAO_T, "Planar")
	...
	ContextActionService:SetTitle(ACAO_Y, "Vendaval")

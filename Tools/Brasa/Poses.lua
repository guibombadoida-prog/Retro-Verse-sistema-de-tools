-- Poses_Fogo_V1.lua
-- ModuleScript "Poses" — Brasa  (conjunto PODER DE FOGO)
--
...
--
--   O mais curto do conjunto: 0.62 s. Ele é o M1 do jogo inteiro, e M1 lento cansa antes de o combate começar.
--
--═══════════════════════════════════════════════════════════════
...
P.PUNHO_CARREGA = {
	RightArm = CFrame.new(1.32, -0.24, 0.34) * CFrame.Angles(math.rad(-34), math.rad(-44), math.rad(30)),
	LeftArm = CFrame.new(-1.42, 0.06, -0.36) * CFrame.Angles(math.rad(30), math.rad(18), math.rad(-12)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(-8), math.rad(-26), math.rad(0)),
	HRP = CFrame.new(0, -0.06, 0) * CFrame.Angles(math.rad(-6), math.rad(-30), math.rad(0)),
}

P.PUNHO_SOBE = {
	RightArm = CFrame.new(1.4, 0.34, -0.82) * CFrame.Angles(math.rad(-52), math.rad(34), math.rad(-18)),
	LeftArm = CFrame.new(-1.38, -0.04, 0.2) * CFrame.Angles(math.rad(-14), math.rad(-16), math.rad(14)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(-14), math.rad(22), math.rad(0)),
	HRP = CFrame.new(0, 0.04, 0) * CFrame.Angles(math.rad(4), math.rad(30), math.rad(0)),
	RightLeg = CFrame.new(0.5, -1.86, -0.3) * CFrame.Angles(math.rad(-18), math.rad(0), math.rad(0)),
...
P.SEQUENCIAS = {
	...
	-- 0.62 s
	PRIMARIA = {
		{ pose = "PUNHO_CARREGA", time = 0.14, style = "Back", dir = "Out" },
		{ pose = "PUNHO_SOBE", time = 0.1, style = "Quint", dir = "Out", marca = "GOLPE", quando = 0.4 },
		{ pose = "RECUO_BAIXO", time = 0.16, style = "Quad", dir = "Out" },
		{ pose = "IDLE", time = 0.22, style = "Quad", dir = "InOut" },
	},

	-- 0.86 s
	EXTRA_R = {
		{ pose = "PUNHO_CARREGA", time = 0.22, style = "Quad", dir = "Out", marca = "CARREGA", quando = 0.7 },
		{ pose = "PUNHO_SOBE", time = 0.12, style = "Quint", dir = "Out", marca = "ESTOURO", quando = 0.3 },
		{ pose = "RECUO_BAIXO", time = 0.26, style = "Quad", dir = "Out", tremor = 0.03, freq = 17 },

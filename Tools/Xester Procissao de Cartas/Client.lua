-- Client.lua
-- Script com RunContext = Client — Xester Procissao de Cartas  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterProcissao_R"
local ACAO_T = "Xester_XesterProcissao_T"
local ACAO_Y = "Xester_XesterProcissao_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Formacao")
	...
	ContextActionService:SetTitle(ACAO_T, "Marcha")
	...
	ContextActionService:SetTitle(ACAO_Y, "Dissolver")

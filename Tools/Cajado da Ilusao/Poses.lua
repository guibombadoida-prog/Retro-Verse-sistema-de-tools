-- Poses.lua
-- ModuleScript "Poses" — Cajado da Ilusao  (conjunto MARIA)
--
...
--
--   ISCA         conjuração       1.30s · 4 passo(s)
--   TROCAR       conjuração       0.78s · 4 passo(s)
--   MULTIPLICAR  golpe pesado     1.34s · 4 passo(s)
--   DISPERSAR    golpe rápido     0.74s · 4 passo(s)
--
...
P.SEQUENCIAS = {
	...
	MULTIPLICAR = {
		...
		{ pose = "ERGUE", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.04, freq = 24, marca = "SEGURA" },
		{ pose = "VARRE", time = 0.18, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.32, style = "Quad", dir = "Out", marca = "FIM" },
	},

	-- golpe rápido · 0.74s · 4 passo(s)
	DISPERSAR = {
		{ pose = "VARRE", time = 0.22, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "VARRE", time = 0.14, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.28, style = "Quad", dir = "Out", marca = "FIM" },
		{ pose = "IDLE", time = 0.1, style = "Sine", dir = "InOut" },
	},

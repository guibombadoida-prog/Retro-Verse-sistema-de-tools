-- CajadodaIlusao_Server_V1.lua
-- Script de servidor — Cajado da Ilusao  (conjunto MARIA)
--
...
--
--   M1   isca   (a habilidade que a origem ja tinha)
--   R    Trocar   (Extra 1)
--   T    Multiplicar   (Extra 2)
--   Y    Dispersar   (Extra 3)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "MariaIlusao", Poses,

-- Client.lua
-- Script com RunContext = Client — Cajado da Ilusao  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaIlusao_R"
local ACAO_T = "Maria_MariaIlusao_T"
local ACAO_Y = "Maria_MariaIlusao_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Trocar")
	...
	ContextActionService:SetTitle(ACAO_T, "Multiplicar")

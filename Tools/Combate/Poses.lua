...
--   CHUTE          golpe rápido     1.20s · 5 passo(s), 2 segurado(s)
--
...
P.SEQUENCIAS = {
	...
	CHUTE = {
		{ pose = "CHUTE_CARGA", time = 0.24, style = "Back", dir = "In", marca = "GIRA" },
		{ pose = "CHUTE_CARGA", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.03, freq = 20, marca = "SEGURA" },
		{ pose = "CHUTE_GIRA", time = 0.12, style = "Quint", dir = "Out", marca = "CHUTA" },
		{ pose = "CHUTE_GIRA", time = 0.18, style = "Sine", dir = "InOut" },

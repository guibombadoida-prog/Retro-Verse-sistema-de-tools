-- XesterWyrmSparks_Server_V1.lua
-- Script de servidor — Xester Wyrm Sparks  (Xester, Forma 2)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: tres cabecas de fogo que perseguem e marcam o chao
--
--   G na Forma 2. Som `842332424` (FOGO), já em uso no repositório.
--
-- A DISTRIBUIÇÃO
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterWyrm", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

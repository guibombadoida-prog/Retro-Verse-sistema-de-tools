-- XesterCurtainReversal_Server_V1.lua
-- Script de servidor — Xester Curtain Reversal  (Xester, Forma 2)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: a cutscene de volta para o baralho
--
--   F na Forma 2. Som `314678645` (ABRE), `413682983` (ESTILHACA) e
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterVolta", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

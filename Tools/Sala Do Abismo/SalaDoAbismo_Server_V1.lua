-- SalaDoAbismo_Server_V1.lua
-- Script de servidor — Sala Do Abismo  (conjunto FAKER)
--
...
--
--   M1   fecha a sala em volta de voce
--   R    Implosao   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "FakerSalaAbismo", Poses, Poses.SEQUENCIAS)
end)

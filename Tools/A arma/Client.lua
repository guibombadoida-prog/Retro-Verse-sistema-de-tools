-- Client.lua
-- Script com RunContext = Client — A arma  (conjunto GUEST)
--
...
local ACAO = "Guest_GuestArma_R"
local ALCANCE_MIRA = 300
...
local function ligarEntrada()
	...
	end, true, Enum.KeyCode.R, Enum.KeyCode.ButtonB)

	ContextActionService:SetTitle(ACAO, "Recarregar")

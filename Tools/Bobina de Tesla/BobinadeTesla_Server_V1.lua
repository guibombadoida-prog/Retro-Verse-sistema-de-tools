-- BobinadeTesla_Server_V1.lua
-- Script de servidor — Bobina de Tesla  (conjunto MAGNETISMO)
--
--   M1   o arco salta de alvo em alvo
--   R    planta a bobina que pulsa   (Extra 1)
--   T    descarrega em todos os carregados   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "BobinadeTesla", Poses,

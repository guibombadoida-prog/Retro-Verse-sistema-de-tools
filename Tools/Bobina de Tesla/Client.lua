-- Client.lua
-- Script com RunContext = Client — Bobina de Tesla  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_BobinadeTesla_R"
local ACAO_T = "Magnetismo_BobinadeTesla_T"
local ALCANCE_MIRA = 100
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Bobina")
	...
	ContextActionService:SetTitle(ACAO_T, "Descarga")

-- IlusaodaAlucinacao_Server_V1.lua
-- Script de servidor — Ilusao da Alucinacao  (conjunto FAKER)
--
...
--
--   M1   espiral que confunde quem olha
--   R    Troca   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "FakerIlusao", Poses, Poses.SEQUENCIAS)
end)

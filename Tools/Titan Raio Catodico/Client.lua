-- Client.lua
-- Script com RunContext = Client — Titan Raio Catodico  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanCatodico_R"
local ACAO_T = "Titan_TitanCatodico_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Feixe")
	...
	ContextActionService:SetTitle(ACAO_T, "Leque")

-- CaixadeSom_Server_V1.lua
-- Script de servidor — Caixa de Som  (conjunto JODRO)
--
...
--
--   M1   onda sonora
--   R    Nunca Te Abandono   (Extra 1)
--   T    Troca de Faixa   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "JodroCaixa", Poses,

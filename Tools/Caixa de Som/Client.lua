-- Client.lua
-- Script com RunContext = Client — Caixa de Som  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroCaixa_R"
local ACAO_T = "Jodro_JodroCaixa_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Nunca Te Abandono")
	...
	ContextActionService:SetTitle(ACAO_T, "Troca de Faixa")

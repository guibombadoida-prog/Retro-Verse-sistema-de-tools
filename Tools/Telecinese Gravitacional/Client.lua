-- Client.lua
-- Script com RunContext = Client — Telecinese Gravitacional  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravGravitacional_R"
local ACAO_T = "Gravidade_GravGravitacional_T"
local ACAO_Y = "Gravidade_GravGravitacional_Y"
local ALCANCE_MIRA = 110
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Singularidade")
	...
	ContextActionService:SetTitle(ACAO_T, "Orbita")
	...
	ContextActionService:SetTitle(ACAO_Y, "Expulsar")

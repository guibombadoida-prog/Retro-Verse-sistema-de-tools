-- MuralhadeFogo_Server_V1.lua
-- Script de servidor — Muralha de Fogo  (conjunto PODER DE FOGO)
--
--   M1   risca o chão e acende a linha
--   R    levanta a muralha que bloqueia   (a Extra)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "MuralhadeFogo", Poses,

-- Client.lua
-- Script com RunContext = Client — Sussy  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroSussy_R"
local ACAO_T = "Jodro_JodroSussy_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Vent")
	...
	ContextActionService:SetTitle(ACAO_T, "Reuniao")

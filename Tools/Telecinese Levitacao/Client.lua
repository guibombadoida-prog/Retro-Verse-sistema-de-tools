-- Client.lua
-- Script com RunContext = Client — Telecinese Levitacao  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravLevitacao_R"
local ACAO_T = "Gravidade_GravLevitacao_T"
local ACAO_Y = "Gravidade_GravLevitacao_Y"
local ALCANCE_MIRA = 80
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Levitar")
	...
	ContextActionService:SetTitle(ACAO_T, "Corrente")
	...
	ContextActionService:SetTitle(ACAO_Y, "Queda")

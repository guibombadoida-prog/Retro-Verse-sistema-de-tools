-- TelecineseLevitacao_Server_V1.lua
-- Script de servidor — Telecinese Levitacao  (conjunto GRAVIDADE)
--
...
--
--   M1   ergue o alvo mirado e o deixa indefeso
--   R    Levitar   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "GravLevitacao", Poses, Poses.SEQUENCIAS)
end)

-- JupiterGrandeMancha_Server_V1.lua
-- Script de servidor — Jupiter Grande Mancha  (conjunto JUPITER)
--
...
--   T    Dispersar   (Extra 2)
--
--   Handle: bastao ocre com disco vermelho girando na ponta
...
local manchaId, manchaOnde = nil, nil
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "JupiterMancha", Poses,

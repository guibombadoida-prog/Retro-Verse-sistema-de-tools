-- Client.lua
-- Script com RunContext = Client — Jupiter Grande Mancha  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterMancha_R"
local ACAO_T = "Jupiter_JupiterMancha_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Olho")
	...
	ContextActionService:SetTitle(ACAO_T, "Dispersar")

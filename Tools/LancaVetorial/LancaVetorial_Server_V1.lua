--[[
	LancaVetorial_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: LancaVetorial → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "LancaVetorial",
	TOOLTIP         = "LancaVetorial - descrição breve da ferramenta",

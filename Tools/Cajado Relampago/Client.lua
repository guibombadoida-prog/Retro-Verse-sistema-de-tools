-- Client.lua
-- Script com RunContext = Client — Cajado Relampago  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaRelampago_R"
local ACAO_T = "Maria_MariaRelampago_T"
local ACAO_Y = "Maria_MariaRelampago_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Tempestade")
	...
	ContextActionService:SetTitle(ACAO_Y, "Para-raios")

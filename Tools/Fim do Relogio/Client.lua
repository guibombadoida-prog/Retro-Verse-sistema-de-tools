-- Client.lua
-- Script com RunContext = Client — Fim do Relogio  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoFim_R"
local ACAO_T = "Tempo_TempoFim_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Ampulheta")
	...
	ContextActionService:SetTitle(ACAO_T, "Fim do Relogio")

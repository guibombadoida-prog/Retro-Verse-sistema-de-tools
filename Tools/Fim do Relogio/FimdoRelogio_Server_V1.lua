-- FimdoRelogio_Server_V1.lua
-- Script de servidor — Fim do Relogio  (conjunto TEMPO)
--
--   M1   Ponteiro
--   R    Ampulheta   (Extra 1)
--   T    Fim do Relogio   (Extra 2)
--
--   Handle autoral: mostrador rachado com cinta Neon
...
local ampulhetaId, ampulhetaAte = nil, 0
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "TempoFim", Poses,

-- Poses_Tempo_V1.lua
-- ModuleScript "Poses" — Fim do Relogio  (conjunto TEMPO)
--
...
P.PESADO = {
	RightArm = CFrame.new(1.42, -0.24, -0.44) * CFrame.Angles(math.rad(20), math.rad(-10), math.rad(12)),
	LeftArm = CFrame.new(-1.42, -0.24, -0.44) * CFrame.Angles(math.rad(20), math.rad(10), math.rad(-12)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(24), math.rad(0), math.rad(0)),
	HRP = CFrame.new(0, -0.52, 0) * CFrame.Angles(math.rad(26), math.rad(0), math.rad(0)),
	RightLeg = CFrame.new(0.5, -1.6, -0.44) * CFrame.Angles(math.rad(-36), math.rad(0), math.rad(0)),
	LeftLeg = CFrame.new(-0.5, -1.6, -0.44) * CFrame.Angles(math.rad(-36), math.rad(0), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	AMPULHETA = {
		...
		{ pose = "SEGURA_ALTO", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.035, freq = 20, marca = "SEGURA" },
		{ pose = "ABRE_CAMPO", time = 0.36, style = "Sine", dir = "InOut", tremor = 0.035, freq = 24 },
	...
	-- épica — 1.52 s
	FIM_RELOGIO = {
		{ pose = "SEGURA_ALTO", time = 0.4, style = "Back", dir = "Out", marca = "CENA" },
		{ pose = "SEGURA_ALTO", time = 0.52, style = "Sine", dir = "InOut", tremor = 0.055, freq = 28, marca = "CARGA" },
		{ pose = "PESADO", time = 0.16, style = "Quint", dir = "Out", tremor = 0.0935, freq = 40, marca = "ESTOURA" },

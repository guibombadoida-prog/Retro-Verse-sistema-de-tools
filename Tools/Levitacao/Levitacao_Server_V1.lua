-- Levitacao_Server_V1.lua
-- Script de servidor — Levitacao  (conjunto MAGNETISMO)
--
--   M1   suspende o alvo no ar
--   R    você flutua   (Extra 1)
--   T    inverte a gravidade da área   (Extra 2)
--
...
local suspensos = setmetatable({}, { __mode = "k" })
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "Levitacao", Poses,

-- Client.lua
-- Script com RunContext = Client — Levitacao  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_Levitacao_R"
local ACAO_T = "Magnetismo_Levitacao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Flutuar")
	...
	ContextActionService:SetTitle(ACAO_T, "Inverter")

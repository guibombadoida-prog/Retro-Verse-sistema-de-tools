-- Client.lua
-- Script com RunContext = Client — Jupiter Pressao Esmagadora  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterPressao_R"
local ACAO_T = "Jupiter_JupiterPressao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Prensa")
	...
	ContextActionService:SetTitle(ACAO_T, "Vacuo")

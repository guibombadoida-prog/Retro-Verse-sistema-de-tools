-- Semente_Server_V1.lua
-- Script de servidor — Semente  (conjunto CRIAÇÃO)
--
--   M1   Broto
--   R    Cipo   (Extra 1)
--   T    Arvore   (Extra 2)
--
--   Handle autoral: galho vivo com folha e broto Neon
...
--- Quem está preso pelo cipó, com a velocidade de ANTES. Chave FRACA.
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "CriacaoSemente", Poses,

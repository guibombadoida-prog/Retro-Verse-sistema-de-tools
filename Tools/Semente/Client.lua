-- Client.lua
-- Script com RunContext = Client — Semente  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoSemente_R"
local ACAO_T = "Criacao_CriacaoSemente_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Cipo")
	...
	ContextActionService:SetTitle(ACAO_T, "Arvore")

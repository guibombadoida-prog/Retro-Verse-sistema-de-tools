...
-- ModuleScript "Poses" — Semente  (conjunto CRIAÇÃO)
--
...
P.AGACHA = {
	RightArm = CFrame.new(1.4, -0.66, -0.44) * CFrame.Angles(math.rad(6), math.rad(-8), math.rad(12)),
	LeftArm = CFrame.new(-1.4, -0.66, -0.44) * CFrame.Angles(math.rad(6), math.rad(8), math.rad(-12)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(34), math.rad(0), math.rad(0)),
	HRP = CFrame.new(0, -0.82, 0) * CFrame.Angles(math.rad(28), math.rad(0), math.rad(0)),
	RightLeg = CFrame.new(0.5, -1.42, -0.52) * CFrame.Angles(math.rad(-56), math.rad(0), math.rad(0)),
	LeftLeg = CFrame.new(-0.52, -1.68, -0.28) * CFrame.Angles(math.rad(-28), math.rad(0), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	-- plantio — 0.90 s
	BROTO = {
		{ pose = "AGACHA", time = 0.22, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "AGACHA", time = 0.14, style = "Quint", dir = "Out", marca = "PLANTA" },
		{ pose = "APRESENTA", time = 0.18, style = "Quad", dir = "Out" },
	...
	ARVORE = {
		...
		{ pose = "ERGUE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.03, freq = 14 },

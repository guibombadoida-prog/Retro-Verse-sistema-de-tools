-- PoloSul_Server_V1.lua
-- Script de servidor — Polo Sul  (conjunto MAGNETISMO)
--
--   M1   empurra o cone à frente, e carrega de SUL
--   R    o escudo que repele quem chega   (Extra 1)
--   T    a onda que limpa o círculo   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "PoloSul", Poses,

-- Client.lua
-- Script com RunContext = Client — Polo Sul  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_PoloSul_R"
local ACAO_T = "Magnetismo_PoloSul_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Escudo")
	...
	ContextActionService:SetTitle(ACAO_T, "Onda")

...
-- ModuleScript "Poses" — Polo Sul  (conjunto MAGNETISMO)
--
...
--
--   A repulsão empurra QUEM EMPURRA: o `EMPURRA_SOLTA` recua o tronco e joga o pé direito à frente para segurar.
--
--═══════════════════════════════════════════════════════════════
...
P.EMPURRA_PALMA = {
	RightArm = CFrame.new(1.4, 0.06, -0.74) * CFrame.Angles(math.rad(24), math.rad(-14), math.rad(-24)),
	LeftArm = CFrame.new(-1.4, 0.06, -0.74) * CFrame.Angles(math.rad(24), math.rad(14), math.rad(24)),
...
P.EMPURRA_SOLTA = {
	RightArm = CFrame.new(1.44, 0.02, -0.98) * CFrame.Angles(math.rad(6), math.rad(-6), math.rad(-8)),
	LeftArm = CFrame.new(-1.44, 0.02, -0.98) * CFrame.Angles(math.rad(6), math.rad(6), math.rad(8)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(6), math.rad(0), math.rad(0)),
	HRP = CFrame.new(0, -0.08, 0) * CFrame.Angles(math.rad(-14), math.rad(0), math.rad(0)),
	RightLeg = CFrame.new(0.5, -1.88, 0.28) * CFrame.Angles(math.rad(18), math.rad(0), math.rad(0)),
	LeftLeg = CFrame.new(-0.52, -1.84, -0.3) * CFrame.Angles(math.rad(-20), math.rad(0), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	-- 0.56 s
	PRIMARIA = {
		{ pose = "EMPURRA_PALMA", time = 0.16, style = "Back", dir = "Out" },
		{ pose = "EMPURRA_SOLTA", time = 0.12, style = "Quint", dir = "Out", marca = "EMPURRAR", quando = 0.3 },
		{ pose = "IDLE", time = 0.28, style = "Quad", dir = "InOut" },
	},

	-- 0.96 s
	EXTRA_R = {
		{ pose = "DIPOLO_ABRE", time = 0.22, style = "Quad", dir = "Out", marca = "ESCUDO", quando = 0.8 },
		{ pose = "DIPOLO_ABRE", time = 0.46, style = "Linear", dir = "Out", tremor = 0.018, freq = 15 },
		{ pose = "IDLE", time = 0.28, style = "Quad", dir = "InOut" },
	},

	-- 1.10 s
	EXTRA_T = {
		{ pose = "EMPURRA_PALMA", time = 0.28, style = "Back", dir = "Out", marca = "CARREGA", quando = 0.65 },
		{ pose = "EMPURRA_SOLTA", time = 0.14, style = "Quint", dir = "Out", marca = "ONDA", quando = 0.4 },
		{ pose = "EMPURRA_SOLTA", time = 0.36, style = "Linear", dir = "Out", tremor = 0.05, freq = 17 },

-- Client.lua
-- Script com RunContext = Client — Meteoro  (conjunto PODER DE FOGO)
--
...
local ACAO_R = "Fogo_Meteoro_R"
local ALCANCE_MIRA = 170
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Meteoro")

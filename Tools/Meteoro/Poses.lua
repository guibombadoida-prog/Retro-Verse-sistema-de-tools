-- Poses_Fogo_V1.lua
-- ModuleScript "Poses" — Meteoro  (conjunto PODER DE FOGO)
--
...
--
--   A escora de 0.62 s é o tempo de o meteoro chegar. Sem ela, o corpo já voltou ao IDLE quando a pedra cai.
--
--═══════════════════════════════════════════════════════════════
...
P.APONTA_CEU = {
	RightArm = CFrame.new(1.36, 0.72, 0.04) * CFrame.Angles(math.rad(-168), math.rad(-12), math.rad(24)),
	LeftArm = CFrame.new(-1.46, 0.16, -0.28) * CFrame.Angles(math.rad(30), math.rad(12), math.rad(-14)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(-34), math.rad(14), math.rad(0)),
	HRP = CFrame.new(0, 0.08, 0) * CFrame.Angles(math.rad(-12), math.rad(10), math.rad(0)),
}

P.APONTA_CHAO = {
	RightArm = CFrame.new(1.46, -0.06, -0.9) * CFrame.Angles(math.rad(62), math.rad(-6), math.rad(-8)),
	LeftArm = CFrame.new(-1.44, -0.02, -0.5) * CFrame.Angles(math.rad(44), math.rad(10), math.rad(14)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(18), math.rad(20), math.rad(0)),
...
P.SEQUENCIAS = {
	...
	-- 0.58 s
	PRIMARIA = {
		{ pose = "APONTA_CHAO", time = 0.16, style = "Back", dir = "Out", marca = "PEDRA", quando = 0.5 },
	...
	-- 1.40 s
	EXTRA_R = {
		{ pose = "APONTA_CEU", time = 0.3, style = "Quad", dir = "Out", marca = "CARREGA", quando = 0.7 },
		{ pose = "APONTA_CHAO", time = 0.16, style = "Quint", dir = "Out", marca = "QUEDA", quando = 0.4 },
		{ pose = "APONTA_CHAO", time = 0.62, style = "Linear", dir = "Out", tremor = 0.036, freq = 13 },

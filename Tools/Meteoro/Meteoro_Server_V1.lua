-- Meteoro_Server_V1.lua
-- Script de servidor — Meteoro  (conjunto PODER DE FOGO)
--
--   M1   atira a pedra em brasa
--   R    chama o meteoro do céu, com marca no chão   (a Extra)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "Meteoro", Poses,

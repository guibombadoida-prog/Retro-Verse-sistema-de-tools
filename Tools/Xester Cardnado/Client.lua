-- Client.lua
-- Script com RunContext = Client — Xester Cardnado  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterCardnado_R"
local ACAO_T = "Xester_XesterCardnado_T"
local ACAO_Y = "Xester_XesterCardnado_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Sopro")
	...
	ContextActionService:SetTitle(ACAO_T, "Olho do Furacao")
	...
	ContextActionService:SetTitle(ACAO_Y, "Dispersar")

-- ColardasTrevas_Server_V1.lua
-- Script de servidor — Colar das Trevas  (conjunto NOOB)
--
...
--
--   M1   agarra o alvo pelo pescoco e drena
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "NoobColarTrevas", Poses, Poses.SEQUENCIAS)
end)

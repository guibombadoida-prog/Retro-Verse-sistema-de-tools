-- Client.lua
-- Script com RunContext = Client — Titan Propulsor  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanPropulsor_R"
local ACAO_T = "Titan_TitanPropulsor_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Voo")
	...
	ContextActionService:SetTitle(ACAO_T, "Desvio")

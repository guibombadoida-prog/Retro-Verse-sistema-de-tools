-- Client.lua
-- Script com RunContext = Client — Titan Sobrecarga  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanSobrecarga_R"
local ACAO_T = "Titan_TitanSobrecarga_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Sobrecarga")
	...
	ContextActionService:SetTitle(ACAO_T, "Reinicio")

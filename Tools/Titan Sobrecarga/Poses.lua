-- Poses_Titan_V1.lua
-- ModuleScript "Poses" — Titan Sobrecarga  (conjunto TITAN)
--
...
P.NUCLEO_ERGUE = {
	RightArm = CFrame.new(1.38, 0.88, -0.16) * CFrame.Angles(math.rad(166), math.rad(-18), math.rad(-26)),
	LeftArm = CFrame.new(-1.38, 0.88, -0.16) * CFrame.Angles(math.rad(166), math.rad(18), math.rad(26)),
	...
	RightLeg = CFrame.new(0.5, -1.92, 0.08) * CFrame.Angles(math.rad(4), math.rad(0), math.rad(0)),
	LeftLeg = CFrame.new(-0.5, -1.92, 0.08) * CFrame.Angles(math.rad(4), math.rad(0), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	-- servo — 1.15 s
	SOBRECARGA = {
		{ pose = "NUCLEO_ERGUE", time = 0.18, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "NUCLEO_ERGUE", time = 0.26, style = "Sine", dir = "InOut", tremor = 0.04, freq = 30, marca = "SEGURA" },
	...
	-- varredura — 1.45 s
	REINICIO = {
		{ pose = "NUCLEO_ERGUE", time = 0.16, style = "Back", dir = "Out", marca = "CARGA" },
		{ pose = "NUCLEO_ERGUE", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.05, freq = 34, marca = "SEGURA" },
		{ pose = "NUCLEO_ERGUE", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.05, freq = 34 },
		{ pose = "NUCLEO_ERGUE", time = 0.15, style = "Quint", dir = "Out", marca = "GOLPE" },

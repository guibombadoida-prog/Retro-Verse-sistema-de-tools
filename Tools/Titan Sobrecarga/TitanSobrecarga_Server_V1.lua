-- TitanSobrecarga_Server_V1.lua
-- Script de servidor — Titan Sobrecarga  (conjunto TITAN)
--
--   M1   Descarga
--   R    Sobrecarga   (Extra 1)
--   T    Reinicio   (Extra 2)
--
--   Handle: nucleo Neon vermelho com aro cromado de contencao
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "TitanSobrecarga", Poses,

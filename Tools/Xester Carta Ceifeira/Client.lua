-- Client.lua
-- Script com RunContext = Client — Xester Carta Ceifeira  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterCeifeira_R"
local ACAO_T = "Xester_XesterCeifeira_T"
local ACAO_Y = "Xester_XesterCeifeira_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Ceifar")
	...
	ContextActionService:SetTitle(ACAO_T, "Marca")
	...
	ContextActionService:SetTitle(ACAO_Y, "Colheita")

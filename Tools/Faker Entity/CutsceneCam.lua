-- CutsceneCam.lua
-- Script com RunContext = Client — conjunto FAKER
--
...
local CFG = {
	...
	PRAZO      = 16,      -- teto de segurança; a maior sequência daqui tem 7.20 s
...
--   Era Do Fim    CAMERA · ERGUE · CARGA · SEGURA · DESCE · DETONA
--   Faker Entity  CAMERA · CHAMA · CARGA · SEGURA · NASCE
--═══════════════════════════════════════════════════════════════

local QUADROS = {
	INVOCADOR = {
		CAMERA = { de = Vector3.new(8, 3.5, 12),   olhar = "portador", fov = 66,  tremor = false },
		ERGUE  = { de = Vector3.new(6, 5, 10),     olhar = "cima", alto = 10, fov = 58, tremor = false },
		CHAMA  = { de = Vector3.new(6, 4.5, 10),   olhar = "cima", alto = 12, fov = 56, tremor = false },
		CARGA  = { de = Vector3.new(5, 6, 9),      olhar = "cima", alto = 16, fov = 52, tremor = false },
		SEGURA = { de = Vector3.new(4.5, 7, 8.5),  olhar = "cima", alto = 22, fov = 48, tremor = true  },
		DESCE  = { de = Vector3.new(7, 4, 11),     olhar = "portador", fov = 56, tremor = false },
		-- o cogumelo tem 522 studs: a câmera SAI, senão o quadro é uma parede
		DETONA = { de = Vector3.new(26, 22, 42),   olhar = "cima", alto = 40, fov = 100, tremor = true },
		NASCE  = { de = Vector3.new(10, 5, 14),    olhar = "cima", alto = 14, fov = 88,  tremor = true },
	},
	ALVO = {
		CAMERA = { de = Vector3.new(-4, 3, 9),      olhar = "eu",       fov = 68, tremor = false },
		ERGUE  = { de = Vector3.new(-3.5, 3.4, 8),  olhar = "portador", fov = 60, tremor = false },
		CHAMA  = { de = Vector3.new(-3.4, 3.6, 8),  olhar = "portador", fov = 58, tremor = false },
		CARGA  = { de = Vector3.new(-3, 3.6, 7),    olhar = "portador", fov = 54, tremor = false },
		SEGURA = { de = Vector3.new(-2.6, 3.8, 6.4), olhar = "portador", fov = 50, tremor = true },
		DESCE  = { de = Vector3.new(-3, 3.2, 7.5),  olhar = "portador", fov = 56, tremor = false },
		DETONA = { de = Vector3.new(-8, 6, 16),     olhar = "cima", alto = 34, fov = 102, tremor = true },
		NASCE  = { de = Vector3.new(-5, 4, 10),     olhar = "cima", alto = 12, fov = 92,  tremor = true },
	},
}

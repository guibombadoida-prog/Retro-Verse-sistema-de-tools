-- Poses_Bomba_V1.lua
-- ModuleScript "Poses" — Bomba de Implosao  (conjunto PODERES DE BOMBA)
--
...
P.SEQUENCIAS = {
	...
	SEMEAR = {
		...
		{ pose = "RECUA", time = 0.24, style = "Quint", dir = "Out", marca = "RECUA" },
	...
	COLAPSO = {
		...
		{ pose = "ERGUE", time = 0.44, style = "Sine", dir = "InOut", tremor = 0.045, freq = 26, marca = "CARGA" },
		{ pose = "SOLTA", time = 0.14, style = "Quint", dir = "Out", tremor = 0.081, freq = 38, marca = "ESTOURA" },

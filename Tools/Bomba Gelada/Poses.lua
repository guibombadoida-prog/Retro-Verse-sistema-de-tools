-- Poses.lua
-- ModuleScript "Poses" — Bomba Gelada
--
...
-- GRAMATICA_R6.md.
--
--   ARREMESSO   golpe rápido         0.92s · impacto 63% · 1 segurado(s)
--
...
P.SEQUENCIAS = {
	...
	-- golpe rápido · 0.92s · 5 passo(s), 1 segurado(s)
	ARREMESSO = {
		{ pose = "ARREMESSO_CARGA", time = 0.22, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "ARREMESSO_CARGA", time = 0.28, style = "Sine", dir = "InOut" },

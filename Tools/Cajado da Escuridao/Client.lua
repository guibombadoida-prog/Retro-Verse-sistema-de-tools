-- Client.lua
-- Script com RunContext = Client — Cajado da Escuridao  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaEscuridao_R"
local ACAO_T = "Maria_MariaEscuridao_T"
local ACAO_Y = "Maria_MariaEscuridao_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Enxame")
	...
	ContextActionService:SetTitle(ACAO_T, "Cegueira")
	...
	ContextActionService:SetTitle(ACAO_Y, "Manto")

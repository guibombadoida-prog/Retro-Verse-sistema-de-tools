-- Client.lua
-- Script com RunContext = Client — Xester Furia do Machado  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterMachado_R"
local ACAO_T = "Xester_XesterMachado_T"
local ACAO_Y = "Xester_XesterMachado_Y"
local ALCANCE_MIRA = 30
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Arremesso")
	...
	ContextActionService:SetTitle(ACAO_T, "Redemoinho")
	...
	ContextActionService:SetTitle(ACAO_Y, "Decapitar")

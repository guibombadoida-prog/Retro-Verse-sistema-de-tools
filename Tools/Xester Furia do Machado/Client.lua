-- Client.lua
-- LocalScript — Xester Furia do Machado
--
...
local SEQUENCIA = "FURIA_DO_MACHADO"
...
local function aoEquipar()
	...
	ContextActionService:BindAction("Xester_XesterFuriadoMachado", function(_nome, estado)
	...
	ContextActionService:SetTitle("Xester_XesterFuriadoMachado", "Gargalhada")
...
local function aoGuardar()
	equipada = false
	soltarTudo()
	ContextActionService:UnbindAction("Xester_XesterFuriadoMachado")

-- Client.lua
-- Script com RunContext = Client — Jupiter Luas Galileanas  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterLuas_R"
local ACAO_T = "Jupiter_JupiterLuas_T"
local ALCANCE_MIRA = 65
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Lanca Io")
	...
	ContextActionService:SetTitle(ACAO_T, "Eclipse")

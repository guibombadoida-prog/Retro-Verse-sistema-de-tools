-- Client.lua
-- Script com RunContext = Client — Tremores da Gravidade  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravTremores_R"
local ACAO_T = "Gravidade_GravTremores_T"
local ACAO_Y = "Gravidade_GravTremores_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Sustentar")
	...
	ContextActionService:SetTitle(ACAO_T, "Falha")
	...
	ContextActionService:SetTitle(ACAO_Y, "Replica")

-- Client.lua
-- Script com RunContext = Client — Bonk  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroBonk_R"
local ACAO_T = "Jodro_JodroBonk_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Mega Bonk")
	...
	ContextActionService:SetTitle(ACAO_T, "Cadeia")

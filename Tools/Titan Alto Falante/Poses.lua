-- Poses_Titan_V1.lua
-- ModuleScript "Poses" — Titan Alto Falante  (conjunto TITAN)
--
...
P.GRITA = {
	RightArm = CFrame.new(1.62, 0.16, 0.3) * CFrame.Angles(math.rad(-22), math.rad(0), math.rad(-62)),
	LeftArm = CFrame.new(-1.62, 0.16, 0.3) * CFrame.Angles(math.rad(-22), math.rad(0), math.rad(62)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(-42), math.rad(0), math.rad(0)),
	HRP = CFrame.new(0, 0.12, 0) * CFrame.Angles(math.rad(-20), math.rad(0), math.rad(0)),
	RightLeg = CFrame.new(0.5, -1.88, -0.2) * CFrame.Angles(math.rad(-12), math.rad(0), math.rad(0)),
	LeftLeg = CFrame.new(-0.5, -1.88, -0.2) * CFrame.Angles(math.rad(-12), math.rad(0), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	CONE = {
		...
		{ pose = "TRAVA_PEITO", time = 0.26, style = "Sine", dir = "InOut", tremor = 0.03, freq = 27, marca = "SEGURA" },
	...
	GRITO = {
		{ pose = "TRAVA_PEITO", time = 0.18, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "TRAVA_PEITO", time = 0.26, style = "Sine", dir = "InOut", tremor = 0.038, freq = 24, marca = "SEGURA" },
		{ pose = "GRITA", time = 0.11, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "GRITA", time = 0.22, style = "Sine", dir = "InOut" },
		{ pose = "IDLE", time = 0.38, style = "Quad", dir = "Out", marca = "FIM" },
	},

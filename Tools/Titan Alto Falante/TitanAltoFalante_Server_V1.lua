-- TitanAltoFalante_Server_V1.lua
-- Script de servidor — Titan Alto Falante  (conjunto TITAN)
--
--   M1   Batida
--   R    Cone   (Extra 1)
--   T    Grito   (Extra 2)
--
--   Handle: caixa acustica com cone de tecido e cupula cromada
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "TitanFalante", Poses,

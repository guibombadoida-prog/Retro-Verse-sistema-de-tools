-- Client.lua
-- Script com RunContext = Client — Titan Alto Falante  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanFalante_R"
local ACAO_T = "Titan_TitanFalante_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Cone")
	...
	ContextActionService:SetTitle(ACAO_T, "Grito")

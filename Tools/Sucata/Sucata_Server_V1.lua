-- Sucata_Server_V1.lua
-- Script de servidor — Sucata  (conjunto MAGNETISMO)
--
--   M1   junta o metal solto numa bola
--   R    arremessa a bola   (Extra 1)
--   T    a chuva de sucata   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "Sucata", Poses,

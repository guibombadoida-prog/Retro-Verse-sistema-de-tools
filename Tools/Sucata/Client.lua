-- Client.lua
-- Script com RunContext = Client — Sucata  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_Sucata_R"
local ACAO_T = "Magnetismo_Sucata_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Arremessar")
	...
	ContextActionService:SetTitle(ACAO_T, "Chuva")

-- SuperDominus_Server_V1.lua
-- Script de servidor — Super Dominus  (conjunto NOOB)
--
...
--
--   M1   a coroa desce — ultimate com cutscene
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "NoobSuperDominus", Poses, Poses.SEQUENCIAS)
end)

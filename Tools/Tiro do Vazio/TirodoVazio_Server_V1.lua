-- TirodoVazio_Server_V1.lua
-- Script de servidor — Tiro do Vazio  (conjunto NOOB)
--
...
--
--   M1   feixe que alcanca 220 studs
--   R    Disparo   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "NoobTiroVazio", Poses, Poses.SEQUENCIAS)
end)

-- ExplosaoNuclear_Server_V1.lua
-- Script de servidor — Explosao Nuclear  (conjunto PODERES DE BOMBA)
--
--   M1   Ogiva
--   R    Cogumelo   (Extra)
--
--   Handle: ogiva branca com ponta vermelha e faixa de radiacao
...
--
--   O M1 é a ogiva que VAI ATÉ LÁ; o R é o cogumelo, que estoura onde você está e deixa a poeira queimando. Um alcança, o outro nega o terreno.
--
-- CONJUNTO AUTORAL
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "BombaNuclear7", Poses,

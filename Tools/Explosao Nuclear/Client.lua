-- Client.lua
-- Script com RunContext = Client — Explosao Nuclear  (conjunto PODERES DE BOMBA)
--
...
local ACAO_R = "Bomba_BombaNuclear7_R"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Cogumelo")

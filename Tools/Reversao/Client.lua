-- Client.lua
-- Script com RunContext = Client — Reversao  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoReversao_R"
local ACAO_T = "Tempo_TempoReversao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Reverter Alvo")
	...
	ContextActionService:SetTitle(ACAO_T, "Reverter a Si")

-- Poses_Tempo_V1.lua
-- ModuleScript "Poses" — Cajado Celeste  (conjunto TEMPO)
--
...
P.SEQUENCIAS = {
	...
	HOLOFOTE = {
		...
		{ pose = "SEGURA_ALTO", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.022, freq = 20, marca = "SEGURA" },
		{ pose = "ABRE_CAMPO", time = 0.36, style = "Sine", dir = "InOut", tremor = 0.022, freq = 24 },

-- Client.lua
-- Script com RunContext = Client — Cajado Celeste  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoCajado_R"
local ACAO_T = "Tempo_TempoCajado_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Holofote")
	...
	ContextActionService:SetTitle(ACAO_T, "Eco do Instante")

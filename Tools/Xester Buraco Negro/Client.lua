-- Client.lua
-- Script com RunContext = Client — Xester Buraco Negro  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterBuraco_R"
local ACAO_T = "Xester_XesterBuraco_T"
local ACAO_Y = "Xester_XesterBuraco_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_T, "Horizonte")
	...
	ContextActionService:SetTitle(ACAO_Y, "Ejecao")

-- Client.lua
-- Script com RunContext = Client — Jupiter Espada de Pressao  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterEspada_R"
local ACAO_T = "Jupiter_JupiterEspada_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_T, "Corte Gigante")

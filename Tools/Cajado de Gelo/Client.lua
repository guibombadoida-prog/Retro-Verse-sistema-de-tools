-- Client.lua
-- Script com RunContext = Client — Cajado de Gelo  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaGelo_R"
local ACAO_T = "Maria_MariaGelo_T"
local ACAO_Y = "Maria_MariaGelo_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Prisao")
	...
	ContextActionService:SetTitle(ACAO_T, "Trilha")
	...
	ContextActionService:SetTitle(ACAO_Y, "Estilhacar")

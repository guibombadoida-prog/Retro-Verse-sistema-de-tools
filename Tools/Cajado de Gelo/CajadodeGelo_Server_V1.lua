-- CajadodeGelo_Server_V1.lua
-- Script de servidor — Cajado de Gelo  (conjunto MARIA)
--
...
--
--   M1   congela   (a habilidade que a origem ja tinha)
--   R    Prisao   (Extra 1)
--   T    Trilha   (Extra 2)
--   Y    Estilhacar   (Extra 3)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "MariaGelo", Poses,

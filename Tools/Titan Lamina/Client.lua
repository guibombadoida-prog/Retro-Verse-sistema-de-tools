-- Client.lua
-- Script com RunContext = Client — Titan Lamina  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanLamina_R"
local ACAO_T = "Titan_TitanLamina_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Estocada")
	...
	ContextActionService:SetTitle(ACAO_T, "Descendente")

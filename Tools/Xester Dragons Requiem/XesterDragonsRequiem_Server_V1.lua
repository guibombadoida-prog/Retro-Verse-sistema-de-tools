-- XesterDragonsRequiem_Server_V1.lua
-- Script de servidor — Xester Dragons Requiem  (Xester, Forma 2)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: segure para carregar; solte para o sopro curvado
--
--   J na Forma 2. Som `2014087015` (SOPRO). O `AcaoRemote` aqui não é
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterRequiem", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

-- XesterTeleporte_Server_V1.lua
-- Script de servidor — Xester Teleporte
--
...
local function montarRig()
	...
	rig = Animator.new(personagem, "XesterTeleporte", Poses, Poses.SEQUENCIAS)
	return rig
end

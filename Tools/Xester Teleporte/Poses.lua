-- Poses.lua
-- ModuleScript "Poses" — Xester Teleporte  (Xester Forma 1)
--
...
--
--   TELEPORTE      conjuração       1.11s · 4 passo(s)
--   MARCAR         conjuração       1.11s · 4 passo(s)
--   VOLTAR         conjuração       1.11s · 4 passo(s)
--   CORRENTE       golpe pesado     1.34s · 4 passo(s)
--
...
P.SEQUENCIAS = {
	...
	TELEPORTE = {
		...
		{ pose = "SOME", time = 0.4, style = "Sine", dir = "InOut", tremor = 0.02, freq = 24 },
	...
	CORRENTE = {
		{ pose = "SOME", time = 0.3, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "SOME", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.045, freq = 26, marca = "SEGURA" },
		{ pose = "ATIRA_CARTA", time = 0.17, style = "Quint", dir = "Out", marca = "GOLPE" },

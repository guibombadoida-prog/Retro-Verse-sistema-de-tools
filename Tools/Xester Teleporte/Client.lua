-- Client.lua
-- Script com RunContext = Client — Xester Teleporte  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterTeleporte_R"
local ACAO_T = "Xester_XesterTeleporte_T"
local ACAO_Y = "Xester_XesterTeleporte_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Marcar")
	...
	ContextActionService:SetTitle(ACAO_T, "Voltar")
	...
	ContextActionService:SetTitle(ACAO_Y, "Corrente")

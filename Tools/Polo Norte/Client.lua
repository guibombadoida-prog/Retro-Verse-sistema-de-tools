-- Client.lua
-- Script com RunContext = Client — Polo Norte  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_PoloNorte_R"
local ACAO_T = "Magnetismo_PoloNorte_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Cúpula")
	...
	ContextActionService:SetTitle(ACAO_T, "Implosão")

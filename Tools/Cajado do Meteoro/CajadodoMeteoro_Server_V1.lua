-- CajadodoMeteoro_Server_V1.lua
-- Script de servidor — Cajado do Meteoro  (conjunto MARIA)
--
...
--
--   M1   meteoro   (a habilidade que a origem ja tinha)
--   R    Chuva   (Extra 1)
--   T    Cratera   (Extra 2)
--   Y    Impacto   (Extra 3)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "MariaMeteoro", Poses,

-- Client.lua
-- Script com RunContext = Client — Cajado do Meteoro  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaMeteoro_R"
local ACAO_T = "Maria_MariaMeteoro_T"
local ACAO_Y = "Maria_MariaMeteoro_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_T, "Cratera")
	...
	ContextActionService:SetTitle(ACAO_Y, "Impacto")

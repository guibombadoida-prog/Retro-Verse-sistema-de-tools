-- Poses.lua
-- ModuleScript "Poses" — Cajado do Meteoro  (conjunto MARIA)
--
...
--
--   METEORO      golpe pesado     1.66s · 4 passo(s)
--   CHUVA        canalizada       3.56s · 5 passo(s)
--   CRATERA      golpe pesado     1.38s · 4 passo(s)
--   IMPACTO      golpe pesado     1.26s · 4 passo(s)
--
...
P.SEQUENCIAS = {
	...
	-- golpe pesado · 1.66s · 4 passo(s)
	METEORO = {
		{ pose = "DUAS_MAOS", time = 0.36, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "DUAS_MAOS", time = 0.74, style = "Sine", dir = "InOut", tremor = 0.055, freq = 28, marca = "SEGURA" },
		{ pose = "APONTA", time = 0.2, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.36, style = "Quad", dir = "Out", marca = "FIM" },
	},

	-- canalizada · 3.56s · 5 passo(s)
	CHUVA = {
		{ pose = "ERGUE", time = 0.5, style = "Back", dir = "In", tremor = 0.03, freq = 18, marca = "CARGA" },
		{ pose = "DUAS_MAOS", time = 0.9, style = "Sine", dir = "InOut", tremor = 0.05, freq = 24 },
		{ pose = "DUAS_MAOS", time = 1.3, style = "Sine", dir = "InOut", tremor = 0.07, freq = 30, marca = "SEGURA" },
		{ pose = "BATE_CHAO", time = 0.26, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.6, style = "Quad", dir = "Out", marca = "FIM" },
	},

	-- golpe pesado · 1.38s · 4 passo(s)
	CRATERA = {
		{ pose = "BATE_CHAO", time = 0.32, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "BATE_CHAO", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.05, freq = 27, marca = "SEGURA" },
		{ pose = "BATE_CHAO", time = 0.18, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.34, style = "Quad", dir = "Out", marca = "FIM" },
	},

	-- golpe pesado · 1.26s · 4 passo(s)
	IMPACTO = {
		{ pose = "RECOLHE", time = 0.3, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "RECOLHE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.045, freq = 26, marca = "SEGURA" },
		{ pose = "VARRE", time = 0.18, style = "Quint", dir = "Out", marca = "GOLPE" },

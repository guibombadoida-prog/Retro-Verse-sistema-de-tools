-- Client.lua
-- Script com RunContext = Client — Prototipo  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoPrototipo_R"
local ACAO_T = "Criacao_CriacaoPrototipo_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Molde")
	...
	ContextActionService:SetTitle(ACAO_T, "Serie")

-- ColapsoMagnetico_Server_V1.lua
-- Script de servidor — Colapso Magnetico  (conjunto MAGNETISMO)
--
--   M1   marca o alvo com carga, ALTERNANDO o pólo
--   R    as cargas se atraem   (Extra 1)
--   T    a singularidade, com cena   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "ColapsoMagnetico", Poses,

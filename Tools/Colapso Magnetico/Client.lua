...
local ACAO_R = "Magnetismo_ColapsoMagnetico_R"
local ACAO_T = "Magnetismo_ColapsoMagnetico_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Atrair")
	...
	ContextActionService:SetTitle(ACAO_T, "Colapso")

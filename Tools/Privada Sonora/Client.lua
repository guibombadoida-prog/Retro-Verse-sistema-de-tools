-- Client.lua
-- Script com RunContext = Client — Privada Sonora  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroPrivada_R"
local ACAO_T = "Jodro_JodroPrivada_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Descarga")
	...
	ContextActionService:SetTitle(ACAO_T, "Coro")

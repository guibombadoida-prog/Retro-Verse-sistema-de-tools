-- Client.lua
-- Script com RunContext = Client — Aceleracao  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoAceleracao_R"
local ACAO_T = "Tempo_TempoAceleracao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Passo Rapido")
	...
	ContextActionService:SetTitle(ACAO_T, "Envelhecer")

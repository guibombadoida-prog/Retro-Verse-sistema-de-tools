-- Fenix_Server_V1.lua
-- Script de servidor — Fenix  (conjunto PODER DE FOGO)
--
--   M1   corte de asa que queima
--   R    o renascer: você sobe em chamas e recupera o que a queimadura tirou   (a Extra)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "Fenix", Poses,

-- LancaChamas_Server_V1.lua
-- Script de servidor — Lanca Chamas  (conjunto PODER DE FOGO)
--
--   M1   o jato contínuo que queima o cone à frente
--   R    a combustão: tudo que está queimando estoura junto   (a Extra)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "LancaChamas", Poses,

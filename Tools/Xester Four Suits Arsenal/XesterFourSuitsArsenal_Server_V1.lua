-- XesterFourSuitsArsenal_Server_V1.lua
-- Script de servidor — Xester Four Suits Arsenal  (Xester, Forma 1)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: oito cartas orbitando; o clique seguinte dispara o naipe
--
--   E na Forma 1. Os quatro Ases saem dos decais do próprio modelo
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterArsenal", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

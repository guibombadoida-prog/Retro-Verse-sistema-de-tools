-- Client.lua
-- Script com RunContext = Client — Alvenaria  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoAlvenaria_R"
local ACAO_T = "Criacao_CriacaoAlvenaria_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_T, "Torre")

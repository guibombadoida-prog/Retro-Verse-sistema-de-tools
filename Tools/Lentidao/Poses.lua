-- Poses_Tempo_V1.lua
-- ModuleScript "Poses" — Lentidao  (conjunto TEMPO)
--
...
P.SEQUENCIAS = {
	...
	CAMPO = {
		...
		{ pose = "SEGURA_ALTO", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.018, freq = 14, marca = "SEGURA" },
		{ pose = "ABRE_CAMPO", time = 0.36, style = "Sine", dir = "InOut", tremor = 0.018, freq = 18 },
	...
	SEGUNDO = {
		{ pose = "ERGUE_MAO", time = 0.24, style = "Back", dir = "Out", marca = "CARGA" },
		{ pose = "SEGURA_ALTO", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.03, freq = 12, marca = "SEGURA" },
		{ pose = "ABRE_CAMPO", time = 0.36, style = "Sine", dir = "InOut", tremor = 0.03, freq = 16 },
		{ pose = "ABRE_CAMPO", time = 0.14, style = "Quint", dir = "Out", marca = "SOLTA" },
		{ pose = "IDLE", time = 0.34, style = "Quad", dir = "Out", marca = "FIM" },
	},

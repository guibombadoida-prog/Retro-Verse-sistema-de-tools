-- Client.lua
-- Script com RunContext = Client — Lentidao  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoLentidao_R"
local ACAO_T = "Tempo_TempoLentidao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Campo Lento")
	...
	ContextActionService:SetTitle(ACAO_T, "Segundo Longo")

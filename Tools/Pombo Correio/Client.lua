-- Client.lua
-- Script com RunContext = Client — Pombo Correio  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroPombo_R"
local ACAO_T = "Jodro_JodroPombo_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Revoada")
	...
	ContextActionService:SetTitle(ACAO_T, "Encomenda")

-- XesterEclipseDeck_Server_V1.lua
-- Script de servidor — Xester Eclipse Deck  (Xester, Forma 1)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: carta negra no ceu que marca e traz todos ao centro
--
--   U na Forma 1, mais o F como Extra. `The Final Deal` foi para cá
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterEclipse", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

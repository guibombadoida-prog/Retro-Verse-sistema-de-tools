-- XesterFullHouse_Server_V1.lua
-- Script de servidor — Xester Full House  (Xester Forma 1)
--
...
--
--   M1   leque de cartas   (a mecânica da origem, preservada)
--   R    Sequencia   (Extra 1)
--   T    Trinca   (Extra 2)
--   Y    Mao Fechada   (Extra 3)
--
-- DE ONDE VEM O MATERIAL
--
--   Forma 1 — as 4 cartas do modelo em `Tool/Moldes/`
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterFullHouse", Poses,

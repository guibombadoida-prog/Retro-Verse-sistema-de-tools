-- Poses.lua
-- ModuleScript "Poses" — Xester Full House  (Xester Forma 1)
--
...
--
--   LEQUE          golpe rápido     0.83s · 5 passo(s)
--   SEQUENCIA      conjuração       1.11s · 4 passo(s)
--   TRINCA         golpe rápido     0.83s · 5 passo(s)
--   MAO_FECHADA    golpe pesado     1.34s · 4 passo(s)
--

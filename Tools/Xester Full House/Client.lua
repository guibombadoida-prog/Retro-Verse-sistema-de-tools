-- Client.lua
-- Script com RunContext = Client — Xester Full House  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterFullHouse_R"
local ACAO_T = "Xester_XesterFullHouse_T"
local ACAO_Y = "Xester_XesterFullHouse_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Sequencia")
	...
	ContextActionService:SetTitle(ACAO_T, "Trinca")
	...
	ContextActionService:SetTitle(ACAO_Y, "Mao Fechada")

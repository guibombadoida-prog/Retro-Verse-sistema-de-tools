-- XesterCurtainCall_Server_V1.lua
-- Script de servidor — Xester Curtain Call  (Xester, Forma 1)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: some em cartas, deixa uma copia e reaparece atras
--
--   Q na Forma 1. Cartas do `cards` do modelo, som `1898092341`
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterCortina", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

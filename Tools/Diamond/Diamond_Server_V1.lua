-- Diamond_Server_V1.lua
-- Script de servidor — Diamond  (conjunto GUEST)
--
...
--
--   M1   tapa que arremessa
--   E    Pedra   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "GuestDiamond", Poses, Poses.SEQUENCIAS)
end)
...
local function desmontar()
	...
	ocupado = false
	devolverVelocidades()
	vfx("PARAR", { id = "PEDRA_" .. tostring(idPedra) })
	if rig then
		rig:CancelSequence()
		rig:ReleaseLegs()
		rig:LockCharacter(false)

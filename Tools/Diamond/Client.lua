-- Client.lua
-- Script com RunContext = Client — Diamond  (conjunto GUEST)
--
...
local ACAO = "Guest_GuestDiamond_E"
...
local function ligarEntrada()
	ContextActionService:BindAction(ACAO, function(_nome, estado)
		...
		AcaoRemote:FireServer("E", mira())
		return Enum.ContextActionResult.Sink
	end, true, Enum.KeyCode.E, Enum.KeyCode.ButtonY)

	ContextActionService:SetTitle(ACAO, "Pedra")

-- Client.lua
-- Script com RunContext = Client — Jupiter Queda do Gigante  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterQueda_R"
local ACAO_T = "Jupiter_JupiterQueda_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Presenca")
	...
	ContextActionService:SetTitle(ACAO_T, "Impacto")

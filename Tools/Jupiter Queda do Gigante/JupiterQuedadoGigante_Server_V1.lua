-- JupiterQuedadoGigante_Server_V1.lua
-- Script de servidor — Jupiter Queda do Gigante  (conjunto JUPITER)
--
...
--   T    Impacto   (Extra 2)
--
--   Handle: o planeta grande cravado num pedestal curto
...
local planetaId, presencaId, planetaOnde = nil, nil, nil
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "JupiterQueda", Poses,

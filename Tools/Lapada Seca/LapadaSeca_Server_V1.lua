-- LapadaSeca_Server_V1.lua
-- Script de servidor — Lapada Seca  (conjunto REALITY)
--
--   M1   tapa em cone; o alvo sai GIRANDO e desaba
--
-- ORIGEM: `SLAP`, de `reality_tools.rbxmx`.
--
--   A origem era dano de contato puro: `Touched` no `Hand`, `TakeDamage`, e nada mais. O tapa não empurrava — o alvo levava dano e continuava exatamente onde estava, o que faz um tapa parecer um arranhão.
--   Aqui ele tem as duas coisas que faltavam: IMPULSO e GIRO. O giro é o que separa um tapa de um empurrão; sem `AngularVelocity` o alvo
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "LapadaSeca", Poses,

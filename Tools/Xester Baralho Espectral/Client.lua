-- Client.lua
-- Script com RunContext = Client — Xester Baralho Espectral  (Xester Forma 2)
--
...
local ACAO_R = "Xester_XesterBaralho_R"
local ACAO_T = "Xester_XesterBaralho_T"
local ACAO_Y = "Xester_XesterBaralho_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Naipe")
	...
	ContextActionService:SetTitle(ACAO_T, "Espelho")
	...
	ContextActionService:SetTitle(ACAO_Y, "Baralho Completo")

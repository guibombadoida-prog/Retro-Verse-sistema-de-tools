...
-- Script de servidor — Xester Baralho Espectral
--
...
local SEQUENCIA = "BARALHO_ESPECTRAL"
...
local function montarRig()
	...
	rig = Animator.new(personagem, "XesterBaralhoEspectral", Poses, Poses.SEQUENCIAS)
	return rig
end

-- Bomba_Meteorica_Server_V1.lua
-- Script de servidor — Bomba Meteórica
--
...
--- As 10 mini bombas sobem e caem. A dispersão é por ângulo áureo, e o raio
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "BombaMeteorica", Poses, Poses.SEQUENCIAS)
end)

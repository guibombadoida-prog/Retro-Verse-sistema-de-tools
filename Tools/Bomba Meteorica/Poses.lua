-- Poses.lua
-- ModuleScript "Poses" — Bomba Meteorica
--
...
-- GRAMATICA_R6.md.
--
--   CHAMADO     conjuração           1.20s · impacto 73% · 1 segurado(s)
--
...
P.SEQUENCIAS = {
	...
	-- conjuração · 1.20s · 4 passo(s), 1 segurado(s)
	CHAMADO = {
		{ pose = "CHAMA_ERGUE", time = 0.34, style = "Back", dir = "In", tremor = 0.03, freq = 20, marca = "ERGUE" },
		{ pose = "CHAMA_ERGUE", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.03, freq = 20 },

--[[
	CampoZeroG_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: CampoZeroG → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "CampoZeroG",
	TOOLTIP         = "CampoZeroG - descrição breve da ferramenta",

-- XesterCrownofCinders_Server_V1.lua
-- Script de servidor — Xester Crown of Cinders  (Xester, Forma 2)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: um sol de Coringa; o clique seguinte estilhaca em brasas
--
--   H na Forma 2. Som `1845012046` (CARREGA) e `1982011510` (FOGO).
--
-- A DISTRIBUIÇÃO
--
...
local coroaId, coroaOnde = nil, nil
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterCoroa", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

-- BoladeFogo_Server_V1.lua
-- Script de servidor — Bola de Fogo  (conjunto PODER DE FOGO)
--
--   M1   arremessa a bola, que voa em arco e quica
--   R    divide a bola em estilhaços   (a Extra)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "BoladeFogo", Poses,

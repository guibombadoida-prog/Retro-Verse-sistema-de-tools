-- Client.lua
-- Script com RunContext = Client — Titan Antena  (conjunto TITAN)
--
...
local ACAO_R = "Titan_TitanAntena_R"
local ACAO_T = "Titan_TitanAntena_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Torre")
	...
	ContextActionService:SetTitle(ACAO_T, "Interferencia")

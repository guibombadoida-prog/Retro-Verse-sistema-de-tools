-- XesterHouseCollapse_Server_V1.lua
-- Script de servidor — Xester House Collapse  (Xester, Forma 1)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: ergue o castelo; o clique seguinte derruba na direcao do mouse
--
--   Y na Forma 1. Som `236989198` (ERGUE) e `765590102` (BATE).
--
-- A DISTRIBUIÇÃO
--
...
local casteloId, casteloOnde = nil, nil
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterCastelo", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

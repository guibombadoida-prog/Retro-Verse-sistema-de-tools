-- XesterAceGate_Server_V1.lua
-- Script de servidor — Xester Ace Gate  (Xester, Forma 1)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: crava o As; o clique seguinte teleporta ate ele
--
--   T na Forma 1. Som `1843578719` (CRAVA) e `1894958339` (SOME).
--
-- A DISTRIBUIÇÃO
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterAs", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

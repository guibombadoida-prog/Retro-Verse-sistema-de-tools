-- Client.lua
-- Script com RunContext = Client — Projeto  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoProjeto_R"
local ACAO_T = "Criacao_CriacaoProjeto_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Esboco")
	...
	ContextActionService:SetTitle(ACAO_T, "Materializar")

...
-- ModuleScript "Poses" — Arma de Fisica  (conjunto REALITY)
--
...
--
--   A ÚNICA sem contragolpe na ida. Ela não solta nada no beat, ela TRAVA — o recuo é contínuo, na `SEGURA_FIRME`.
--
...
P.MIRA_GARRA = {
	RightArm = CFrame.new(1.44, 0.1, -0.9) * CFrame.Angles(math.rad(-2), math.rad(-6), math.rad(-4)),
	LeftArm = CFrame.new(-1.34, 0.04, -0.66) * CFrame.Angles(math.rad(22), math.rad(34), math.rad(8)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(-2), math.rad(-4), math.rad(0)),
	HRP = CFrame.new(0, 0, 0) * CFrame.Angles(math.rad(0), math.rad(-10), math.rad(0)),
}
...
P.SEGURA_FIRME = {
	RightArm = CFrame.new(1.42, 0.06, -0.94) * CFrame.Angles(math.rad(6), math.rad(-4), math.rad(-6)),
	LeftArm = CFrame.new(-1.3, 0.02, -0.72) * CFrame.Angles(math.rad(26), math.rad(38), math.rad(10)),
	Head = CFrame.new(0, 1.5, 0) * CFrame.Angles(math.rad(2), math.rad(-2), math.rad(0)),
	HRP = CFrame.new(0, -0.04, 0) * CFrame.Angles(math.rad(4), math.rad(-12), math.rad(0)),
}
...
P.SEQUENCIAS = {
	...
	-- 0.30 s
	PRIMARIA = {
		{ pose = "MIRA_GARRA", time = 0.12, style = "Quad", dir = "Out", marca = "TRAVA" },
		{ pose = "SEGURA_FIRME", time = 0.18, style = "Quad", dir = "InOut" },
	},

	-- 0.44 s
	SOLTAR = {
		{ pose = "MIRA_GARRA", time = 0.1, style = "Quint", dir = "Out", marca = "SOLTA" },
		{ pose = "RECUO_ALTO", time = 0.14, style = "Quad", dir = "Out" },
		{ pose = "IDLE", time = 0.2, style = "Quad", dir = "InOut" },
	},

-- FerroviaMagnetica_Server_V1.lua
-- Script de servidor — Ferrovia Magnetica  (conjunto MAGNETISMO)
--
--   M1   assenta o trilho, que arrasta quem pisa
--   R    lança você pelo próprio trilho   (Extra 1)
--   T    cruza a malha inteira   (Extra 2)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "FerroviaMagnetica", Poses,

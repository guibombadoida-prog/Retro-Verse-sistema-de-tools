-- Client.lua
-- Script com RunContext = Client — Ferrovia Magnetica  (conjunto MAGNETISMO)
--
...
local ACAO_R = "Magnetismo_FerroviaMagnetica_R"
local ACAO_T = "Magnetismo_FerroviaMagnetica_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Montar")
	...
	ContextActionService:SetTitle(ACAO_T, "Malha")

-- Client.lua
-- Script com RunContext = Client — Deu Ruim  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroDeuRuim_R"
local ACAO_T = "Jodro_JodroDeuRuim_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Stonks")
	...
	ContextActionService:SetTitle(ACAO_T, "Not Stonks")

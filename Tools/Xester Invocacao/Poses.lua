-- Poses.lua
-- ModuleScript "Poses" — Xester Invocacao  (Xester Forma 2)
--
...
--
--   INVOCAR        conjuração       1.11s · 4 passo(s)
--   COMANDAR       conjuração       1.11s · 4 passo(s)
--   LEGIAO         golpe pesado     1.34s · 4 passo(s)
--   DISPENSAR      golpe pesado     1.34s · 4 passo(s)
--
...
P.SEQUENCIAS = {
	...
	INVOCAR = {
		...
		{ pose = "CAJADO_CHAO", time = 0.15, style = "Quint", dir = "Out", marca = "GOLPE" },
	...
	LEGIAO = {
		...
		{ pose = "CONVOCA", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.05, freq = 25, marca = "SEGURA" },

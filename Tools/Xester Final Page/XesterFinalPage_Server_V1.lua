-- XesterFinalPage_Server_V1.lua
-- Script de servidor — Xester Final Page  (Xester, Forma 2)
--
--═══════════════════════════════════════════════════════════════
-- ESTA TOOL: para o tempo; tres cliques marcam; o dragao celeste atravessa
--
--   L na Forma 2. Som `54111471` (FIM) e `1040136448` (ECO).
--
-- A DISTRIBUIÇÃO
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "XesterPagina", Poses, Poses.SEQUENCIAS,
		Poses.TRACKS)

-- Client.lua
-- Script com RunContext = Client — Chinelo Voador  (conjunto JODRO)
--
...
local ACAO_R = "Jodro_JodroChinelo_R"
local ACAO_T = "Jodro_JodroChinelo_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Teleguiado")
	...
	ContextActionService:SetTitle(ACAO_T, "Mae Brava")

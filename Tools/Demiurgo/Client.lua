-- Client.lua
-- Script com RunContext = Client — Demiurgo  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoDemiurgo_R"
local ACAO_T = "Criacao_CriacaoDemiurgo_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Continente")
	...
	ContextActionService:SetTitle(ACAO_T, "Criacao")

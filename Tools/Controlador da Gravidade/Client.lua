-- Client.lua
-- Script com RunContext = Client — Controlador da Gravidade  (conjunto GRAVIDADE)
--
...
local ACAO_R = "Gravidade_GravControlador_R"
local ACAO_T = "Gravidade_GravControlador_T"
local ACAO_Y = "Gravidade_GravControlador_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Esmagar")
	...
	ContextActionService:SetTitle(ACAO_T, "Campo Leve")
	...
	ContextActionService:SetTitle(ACAO_Y, "Pulso Radial")

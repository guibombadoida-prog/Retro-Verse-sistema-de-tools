-- JulgamentoFinal_Server_V1.lua
-- Script de servidor — Julgamento Final (conjunto COLLECTOR)
--
...
local function montarRig()
	...
	rig = Animator.new(personagem, "JulgamentoFinal", Poses, Poses.SEQUENCIAS)
	return rig
end
...
local function animar()
	...
	atual:PlaySequence("SELAR", function(passo)
...
local function limpar()
	soltarTudo()
	soltarPresos()
	encerrarSentenca("tool guardada")
end

-- Poses_Tempo_V1.lua
-- ModuleScript "Poses" — Instante Parado  (conjunto TEMPO)
--
...
P.SEQUENCIAS = {
	...
	ZONA = {
		...
		{ pose = "SEGURA_ALTO", time = 0.42, style = "Sine", dir = "InOut", tremor = 0.02, freq = 16, marca = "SEGURA" },
		{ pose = "ABRE_CAMPO", time = 0.36, style = "Sine", dir = "InOut", tremor = 0.02, freq = 20 },

-- Client.lua
-- Script com RunContext = Client — Instante Parado  (conjunto TEMPO)
--
...
local ACAO_R = "Tempo_TempoParada_R"
local ACAO_T = "Tempo_TempoParada_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Zona Parada")
	...
	ContextActionService:SetTitle(ACAO_T, "Retomar")

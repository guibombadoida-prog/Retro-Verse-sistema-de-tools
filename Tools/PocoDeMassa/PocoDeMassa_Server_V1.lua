--[[
	PocoDeMassa_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: PocoDeMassa → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "PocoDeMassa",
	TOOLTIP         = "PocoDeMassa - descrição breve da ferramenta",

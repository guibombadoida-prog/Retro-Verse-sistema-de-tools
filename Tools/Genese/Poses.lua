...
-- ModuleScript "Poses" — Genese  (conjunto CRIAÇÃO)
--
...
P.SEQUENCIAS = {
	...
	MATERIA = {
		...
		{ pose = "ERGUE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.028, freq = 22 },
	...
	PRIMEIRO = {
		...
		{ pose = "PALMAS_BAIXO", time = 0.16, style = "Sine", dir = "InOut", marca = "SEGURA" },
		{ pose = "ERGUE", time = 0.14, style = "Quint", dir = "Out", marca = "ERGUE" },
		{ pose = "ERGUE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.044, freq = 24 },
		{ pose = "IDLE", time = 0.34, style = "Quad", dir = "Out", marca = "FIM" },
	},

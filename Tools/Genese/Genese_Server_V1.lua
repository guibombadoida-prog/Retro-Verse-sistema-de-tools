-- Genese_Server_V1.lua
-- Script de servidor — Genese  (conjunto CRIAÇÃO)
--
--   M1   Faisca
--   R    Materia   (Extra 1)
--   T    Primeiro Instante   (Extra 2)
--
--   Handle autoral: esfera de materia crua entre dois aneis de latao
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "CriacaoGenese", Poses,

-- Client.lua
-- Script com RunContext = Client — Xester Ato de Desaparecer  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterAto_R"
local ACAO_T = "Xester_XesterAto_T"
local ACAO_Y = "Xester_XesterAto_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Baralhar")
	...
	ContextActionService:SetTitle(ACAO_T, "Blefe")
	...
	ContextActionService:SetTitle(ACAO_Y, "Grande Final")

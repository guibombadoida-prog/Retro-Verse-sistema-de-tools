-- Client.lua
-- Script com RunContext = Client — Jupiter Cinturao de Radiacao  (conjunto JUPITER)
--
...
local ACAO_R = "Jupiter_JupiterRadiacao_R"
local ACAO_T = "Jupiter_JupiterRadiacao_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Pulso")
	...
	ContextActionService:SetTitle(ACAO_T, "Blindagem")

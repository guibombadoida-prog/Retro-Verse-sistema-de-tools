-- JupiterCinturaodeRadiacao_Server_V1.lua
-- Script de servidor — Jupiter Cinturao de Radiacao  (conjunto JUPITER)
--
...
--   T    Blindagem   (Extra 2)
--
--   Handle: planeta pequeno com o anel verde do cinturao
...
local cintoId, escudoId, cancelarReducao = nil, nil, nil
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "JupiterRadiacao", Poses,

-- Client.lua
-- Script com RunContext = Client — Xester Carta Colossal  (Xester Forma 1)
--
...
local ACAO_R = "Xester_XesterColossal_R"
local ACAO_T = "Xester_XesterColossal_T"
local ACAO_Y = "Xester_XesterColossal_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Muralha")
	...
	ContextActionService:SetTitle(ACAO_T, "Guilhotina")
	...
	ContextActionService:SetTitle(ACAO_Y, "Baralho Colossal")

...
-- Script de servidor — Xester Carta Colossal
--
--   M1   Ergue uma carta de 24 studs e derruba a 21 de distancia.
--   Y    Bola De Fogo Imensa (habilidade Extra)
--
...
local CFG = {
	...
	RECARGA_EXTRA = 12,
	ALCANCE = 60,
	CARTA = Vector3.new(15.65, 23.84, 0.3),
	SUBIDA = 18,
	AVANCO = 21,
	FUNDO = 3,
	CARGA = 0.55,
...
local function dispararExtra(ponto)
	animar(SEQUENCIA_EXTRA, function()
		tocarEm("FOGO", raiz.Position, 0.85)
		extra(ponto)
	end)
end

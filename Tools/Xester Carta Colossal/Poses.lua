-- Poses.lua
-- ModuleScript "Poses" — Xester Carta Colossal  (Xester Forma 1)
--
...
--
--   COLOSSAL       golpe pesado     1.34s · 4 passo(s)
--   MURALHA        conjuração       1.11s · 4 passo(s)
--   GUILHOTINA     golpe rápido     0.83s · 5 passo(s)
--   BARALHO        golpe pesado     1.34s · 4 passo(s)
--
...
P.SEQUENCIAS = {
	...
	COLOSSAL = {
		...
		{ pose = "CARTOLA", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.055, freq = 28, marca = "SEGURA" },
	...
	BARALHO = {
		{ pose = "CARTOLA", time = 0.3, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "CARTOLA", time = 0.54, style = "Sine", dir = "InOut", tremor = 0.05, freq = 27, marca = "SEGURA" },
		{ pose = "PALMA_ABERTA", time = 0.17, style = "Quint", dir = "Out", marca = "GOLPE" },
		{ pose = "IDLE", time = 0.33, style = "Quad", dir = "Out", marca = "FIM" },
	},

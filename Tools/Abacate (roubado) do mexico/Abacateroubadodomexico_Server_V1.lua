-- Abacateroubadodomexico_Server_V1.lua
-- Script de servidor — Abacate (roubado) do mexico  (conjunto GUEST)
--
...
--
--   M1   come e recupera vida
--   R    Caroco   (Extra, por `AcaoRemote` — e por botão no celular)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "GuestAbacate", Poses, Poses.SEQUENCIAS)
	tocar("OpenSound", 1)
end)

-- Client.lua
-- Script com RunContext = Client — Cajado Curador  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaCurador_R"
local ACAO_T = "Maria_MariaCurador_T"
local ACAO_Y = "Maria_MariaCurador_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Roubar")
	...
	ContextActionService:SetTitle(ACAO_T, "Bencao")
	...
	ContextActionService:SetTitle(ACAO_Y, "Ressurgir")

-- Client.lua
-- Script com RunContext = Client — Bomba Orbital  (conjunto PODERES DE BOMBA)
--
...
local ACAO_R = "Bomba_BombaOrbital_R"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Queda Orbital")

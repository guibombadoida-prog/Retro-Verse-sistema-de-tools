-- Poses_Bomba_V1.lua
-- ModuleScript "Poses" — Bomba Orbital  (conjunto PODERES DE BOMBA)
--
...
P.SEQUENCIAS = {
	...
	ORBITA = {
		...
		{ pose = "ERGUE", time = 0.44, style = "Sine", dir = "InOut", tremor = 0.035, freq = 20, marca = "CARGA" },
		{ pose = "SOLTA", time = 0.14, style = "Quint", dir = "Out", tremor = 0.06300000000000001, freq = 32, marca = "ESTOURA" },

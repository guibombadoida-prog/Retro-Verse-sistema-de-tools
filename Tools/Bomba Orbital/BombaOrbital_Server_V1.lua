-- BombaOrbital_Server_V1.lua
-- Script de servidor — Bomba Orbital  (conjunto PODERES DE BOMBA)
--
--   M1   Marcar
--   R    Queda Orbital   (Extra)
--
--   Handle: farol com prato cromado, haste e ponta Neon azul
...
--
--   O M1 planta o FAROL e o R chama a queda EM CIMA DELE. Sem farol, o R cai onde você está — que é onde você não quer.
--
-- CONJUNTO AUTORAL
--
...
local farolId, farolOnde, farolAte = nil, nil, 0
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "BombaOrbital", Poses,

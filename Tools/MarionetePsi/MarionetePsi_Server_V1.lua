--[[
	MarionetePsi_Server_V1  —  Server Script, filho direto da Tool
	...
	Renomear ao copiar: MarionetePsi → nome real da Tool, em TODO o arquivo.
--]]
...
local CFG = {
	NOME            = "MarionetePsi",
	TOOLTIP         = "MarionetePsi - descrição breve da ferramenta",

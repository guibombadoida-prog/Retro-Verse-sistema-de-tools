...
-- Script de servidor — Samsungus  (conjunto REALITY)
--
--   M1   arremessa o aparelho, que QUICA e estoura no fim
--
-- ORIGEM: `samsung`, de `reality_tools.rbxmx`.
--
--   A origem era pancada de contato com o aparelho na mão. O que ela tem de aproveitável não está nela: está na `ClassicSuperball` do MESMO arquivo, que arremessava uma peça com `Elasticity = 1` e
--   `Friction = 0` — uma bola que ricocheteia de verdade. Só que o jeito dela era `missile.Velocity = direction * 200`, e a 60 Hz isso é
--   um salto de 3,3 studs por quadro: a peça atravessa parede fina e o `Touched` nunca dispara.
--   Aqui o quique é REAL e não atravessa nada: o projétil é integrado à mão e entre dois passos vai um raycast, com reflexão v' = v - 2(v·n)n.
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "Samsungus", Poses,

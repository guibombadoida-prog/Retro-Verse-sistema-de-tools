-- Client.lua
-- Script com RunContext = Client — Samsungus  (conjunto REALITY GUI)
--
...
local ACAO = "Reality_RealitySamsungus_R"
local ALCANCE_MIRA = 35
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO, "Concussao")

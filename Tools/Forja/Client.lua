-- Client.lua
-- Script com RunContext = Client — Forja  (conjunto CRIAÇÃO)
--
...
local ACAO_R = "Criacao_CriacaoForja_R"
local ACAO_T = "Criacao_CriacaoForja_T"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Bigorna")
	...
	ContextActionService:SetTitle(ACAO_T, "Tempera")

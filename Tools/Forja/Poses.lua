...
-- ModuleScript "Poses" — Forja  (conjunto CRIAÇÃO)
--
...
P.SEQUENCIAS = {
	...
	BIGORNA = {
		...
		{ pose = "ERGUE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.03, freq = 18 },
	...
	TEMPERA = {
		...
		{ pose = "PALMAS_BAIXO", time = 0.16, style = "Sine", dir = "InOut", marca = "SEGURA" },
		{ pose = "ERGUE", time = 0.14, style = "Quint", dir = "Out", marca = "ERGUE" },
		{ pose = "ERGUE", time = 0.46, style = "Sine", dir = "InOut", tremor = 0.022, freq = 20 },
		{ pose = "IDLE", time = 0.34, style = "Quad", dir = "Out", marca = "FIM" },
	},

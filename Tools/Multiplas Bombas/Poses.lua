-- Poses.lua
-- ModuleScript "Poses" — Multiplas Bombas
--
...
-- GRAMATICA_R6.md.
--
--   ARREMESSO   golpe rápido         0.90s · impacto 56% · 1 segurado(s)
--
...
P.SEQUENCIAS = {
	...
	ARREMESSO = {
		{ pose = "ARREMESSO_CARGA", time = 0.18, style = "Back", dir = "In", marca = "CARGA" },
		{ pose = "ARREMESSO_CARGA", time = 0.24, style = "Sine", dir = "InOut" },

-- CajadodasEstrelas_Server_V1.lua
-- Script de servidor — Cajado das Estrelas  (conjunto MARIA)
--
...
--
--   M1   estrela   (a habilidade que a origem ja tinha)
--   R    Chuva   (Extra 1)
--   T    Constelacao   (Extra 2)
--   Y    Estrela-guia   (Extra 3)
--
...
Tool.Equipped:Connect(function()
	...
	rig = Animator.new(personagem, "MariaEstrelas", Poses,

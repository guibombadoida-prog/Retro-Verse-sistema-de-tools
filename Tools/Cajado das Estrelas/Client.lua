-- Client.lua
-- Script com RunContext = Client — Cajado das Estrelas  (conjunto MARIA)
--
...
local ACAO_R = "Maria_MariaEstrelas_R"
local ACAO_T = "Maria_MariaEstrelas_T"
local ACAO_Y = "Maria_MariaEstrelas_Y"
...
local function ligarEntrada()
	...
	ContextActionService:SetTitle(ACAO_R, "Chuva")
	...
	ContextActionService:SetTitle(ACAO_T, "Constelacao")
	...
	ContextActionService:SetTitle(ACAO_Y, "Estrela-guia")

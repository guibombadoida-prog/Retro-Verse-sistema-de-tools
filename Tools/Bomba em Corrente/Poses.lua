-- Poses_Bomba_V1.lua
-- ModuleScript "Poses" — Bomba em Corrente  (conjunto PODERES DE BOMBA)
--
...
P.SEQUENCIAS = {
	...
	REACAO = {
		...
		{ pose = "ERGUE", time = 0.44, style = "Sine", dir = "InOut", tremor = 0.05, freq = 28, marca = "CARGA" },
		{ pose = "SOLTA", time = 0.14, style = "Quint", dir = "Out", tremor = 0.09000000000000001, freq = 40, marca = "ESTOURA" },

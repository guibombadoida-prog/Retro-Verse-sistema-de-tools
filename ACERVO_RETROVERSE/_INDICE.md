...
| `Poses_Xester_V2` | **autoral**, sobre o vocabulário extraído | 22 seq · 13 habilidades + 3 cutscenes | **LIMPO** | as 13 Tools (7 + 6), cada uma só com as suas |
...
| `Xester_Forma1/` | **LIMPO** — base das 7 Tools da Forma 1; kit refeito em 2026-08-19 | [FICHA.md](Xester_Forma1/FICHA.md) |
| ↳ o baralho `cards` | serve **as duas** formas: Handle e moldes de carta da Forma 1 saem dele | — |
| `Xester_Forma2_O_Despertar/` | **LIMPO** — base das 6 Tools da Forma 2; kit refeito em 2026-08-19 | [FICHA.md](Xester_Forma2_O_Despertar/FICHA.md) |
...
| `Calebe_Tools/` | **LIMPO** — base das **7 Tools** do conjunto GRAVIDADE, 28 habilidades desde 2026-08-19 | [FICHA.md](Calebe_Tools/FICHA.md) |

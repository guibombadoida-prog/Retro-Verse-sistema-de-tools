#!/usr/bin/env python3
"""
montar_submundo.py — Retro-Verse / Studios

Monta o arquivo de entrega do conjunto SUBMUNDO e o `.rbxmx` avulso de cada uma
das 6 Tools, com o pack de VFX do Acervo copiado para dentro.

    python3 FERRAMENTAS/montar_submundo.py
"""
...
def main():
    destino = os.path.join(TOOLS, "Submundo_6_Tools.rbxmx")
    raiz = nova_raiz()
    ...
    print("MONTAGEM — conjunto SUBMUNDO")
    print("")
